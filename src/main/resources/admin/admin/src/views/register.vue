    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">果蔬作物疾病防治系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item v-if="zhuanjiaPhotoFlag">
                            </el-form-item>
                            <el-form-item label="专家头像" class="input" v-if="tableName=='zhuanjia'">
                                    <file-upload
                                        tip="点击上传专家头像"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.zhuanjiaPhoto?$base.url+ruleForm.zhuanjiaPhoto:''"
                                        @change="zhuanjiaPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="研究方向" class="input" v-if="tableName=='zhuanjia'">
                                <el-input v-model="ruleForm.yanjiufangxiangTypes" autocomplete="off" placeholder="研究方向"  />
                           </el-form-item>
                        -->
                        <el-form-item label="专家邮箱" class="input" v-if="tableName=='zhuanjia'">
                            <el-input v-model="ruleForm.zhuanjiaEmail" autocomplete="off" placeholder="专家邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="专家介绍" class="input" v-if="tableName=='zhuanjia'">
                                <el-input type="textarea" v-model="ruleForm.zhuanjiaContent" placeholder="专家介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="创建时间 show1 show2 photoShow" class="input" v-if="tableName=='zhuanjia'">
    ...
    export default {
        data() {
            return {
                ...
                zhuanjiaPhotoFlag:false,//用于刷新文件上传
            };
        },
        mounted(){
        ...
        methods: {
            ...
            zhuanjiaPhotoUploadChange(fileUrls) {
               this.ruleForm.zhuanjiaPhoto = fileUrls;
                if(this.zhuanjiaPhotoFlag){
                    this.zhuanjiaPhotoFlag=false;
                }else{
                    this.zhuanjiaPhotoFlag=true;
                }
            },
            close(){
            ...
            login() {
                            ...
                            // zhuanjia 中的 专家头像 判空处理
                            // if('zhuanjia' == this.tableName && (this.ruleForm.zhuanjiaPhoto== null ||this.ruleForm.zhuanjiaPhoto== "")){
                            //     this.$message.error("专家头像不能为空");
                            //     return
                            // }
                            // zhuanjia 中的 研究方向 判空处理
                            // if('zhuanjia' == this.tableName && (this.ruleForm.yanjiufangxiangTypes== null ||this.ruleForm.yanjiufangxiangTypes== "")){
                            ...
                            // zhuanjia 中的 专家介绍 判空处理
                            // if('zhuanjia' == this.tableName && (this.ruleForm.zhuanjiaContent== null ||this.ruleForm.zhuanjiaContent== "")){
                            //     this.$message.error("专家介绍不能为空");
                            //     return
                            // }
                            // zhuanjia 中的 创建时间 show1 show2 photoShow 判空处理
                            // if('zhuanjia' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/guoshuzuowujibingfangzhi/img/back-img-bg.jpg);
