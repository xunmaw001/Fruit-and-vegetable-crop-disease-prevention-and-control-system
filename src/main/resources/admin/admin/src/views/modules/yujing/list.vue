        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '预警名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.yujingName" placeholder="预警名称" clearable></el-input>
                     </el-form-item>
                 
                     <el-form-item :label="contents.inputTitle == 1 ? '预警类型' : ''">
                        <el-select v-model="searchForm.yujingTypes" placeholder="请选择预警类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in yujingTypesSelectSearch"
                               v-bind:key="index"
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/guoshuzuowujibingfangzhi/upload/yujingMuBan.xls"
                        >批量导入预警数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yujing','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.yujingTypes!= '' && this.searchForm.yujingTypes!= undefined) {
                    params['yujingTypes'] = this.searchForm.yujingTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=yujing_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.yujingTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
