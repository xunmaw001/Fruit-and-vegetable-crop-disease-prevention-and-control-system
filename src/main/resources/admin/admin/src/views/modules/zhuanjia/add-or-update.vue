        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhuanjiaPhoto" label="专家头像" prop="zhuanjiaPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.zhuanjiaPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="研究方向" prop="yanjiufangxiangTypes">
                        <el-select v-model="ruleForm.yanjiufangxiangTypes" :disabled="ro.yanjiufangxiangTypes" placeholder="请选择研究方向">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="研究方向" prop="yanjiufangxiangValue">
                        <el-input v-model="ruleForm.yanjiufangxiangValue"
                            placeholder="研究方向" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="专家邮箱" prop="zhuanjiaEmail">
                       <el-input v-model="ruleForm.zhuanjiaEmail"
                                 placeholder="专家邮箱" clearable  :readonly="ro.zhuanjiaEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zhuanjiaEmail: [
                              { required: true, message: '专家邮箱不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.zhuanjiaContent = _this.ruleForm.zhuanjiaContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.zhuanjiaContent = this.ruleForm.zhuanjiaContent.replaceAll(this.$base.url,"");
                        this.$http({
