        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '研究方向' : ''">
                        <el-select v-model="searchForm.yanjiufangxiangTypes" placeholder="请选择研究方向">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in yanjiufangxiangTypesSelectSearch"
                               v-bind:key="index"
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/guoshuzuowujibingfangzhi/upload/zhuanjiaMuBan.xls"
                        >批量导入专家数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('zhuanjia','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="zhuanjiaPhoto"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.zhuanjiaPhoto">
                                <img :src="$base.url+scope.row.zhuanjiaPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="yanjiufangxiangTypes"
                                      header-align="center"
                                      label="研究方向">
                        <template slot-scope="scope">
                            {{scope.row.yanjiufangxiangValue}}
                        </template>
                    </el-table-column>
