  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='zhuanjia'"  label='研究方向' prop="yanjiufangxiangTypes">
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='zhuanjia'"  label='专家邮箱' prop="zhuanjiaEmail">
               <el-input v-model="ruleForm.zhuanjiaEmail"  placeholder='专家邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
|| flag=='zhuanjia')"  label="性别" prop="sexTypes">
...
// 注册表 专家 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yanjiufangxiangTypes)&& 'zhuanjia'==this.flag){
