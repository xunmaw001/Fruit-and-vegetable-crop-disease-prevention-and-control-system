...
var centerMenu = [
    ...
    ,{
        name: '果蔬百科收藏',
        url: '../guoshuCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '果蔬百科',
        url: './pages/guoshu/list.html'
    },
    {
        name: '预警',
        url: './pages/yujing/list.html'
    },
    {
        name: '专家',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/guoshuzuowujibingfangzhi/admin/dist/index.html#/login";
