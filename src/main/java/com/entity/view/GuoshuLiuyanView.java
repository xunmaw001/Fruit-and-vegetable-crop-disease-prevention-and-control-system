...
public class GuoshuLiuyanView extends GuoshuLiuyanEntity implements Serializable {
	...
	public GuoshuLiuyanView() {

	}

	public GuoshuLiuyanView(GuoshuLiuyanEntity guoshuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, guoshuLiuyanEntity);
